...
python3 "$(pwd)/methods/pnn_ppo_continued_learning.py" --seed=1 \
--number_hs=19 --dynamic_weighting_of_learning_p=1 \
--track --wandb_project_name="$WANDB_PROJECT_NAME" --easy=1 --use_monochrome=0 \
--total_timesteps=9000000 --env_id="procgen:procgen-starpilot-v0" \
--int_env_id="procgen:procgen-climber-v0" --proc_sequential

python3 "$(pwd)/methods/pnn_ppo_continued_learning.py" --seed=2 \
--number_hs=19 --dynamic_weighting_of_learning_p=1 \
--track --wandb_project_name="$WANDB_PROJECT_NAME" --easy=1 --use_monochrome=0 \
--total_timesteps=9000000 --env_id="procgen:procgen-starpilot-v0" \
--int_env_id="procgen:procgen-climber-v0" --proc_sequential

python3 "$(pwd)/methods/pnn_ppo_continued_learning.py" --seed=3 \
--number_hs=19 --dynamic_weighting_of_learning_p=1 \
--track --wandb_project_name="$WANDB_PROJECT_NAME" --easy=1 --use_monochrome=0 \
--total_timesteps=9000000 --env_id="procgen:procgen-starpilot-v0" \
--int_env_id="procgen:procgen-climber-v0" --proc_sequential

python3 "$(pwd)/methods/pnn_ppo_continued_learning.py" --seed=4 \
--number_hs=19 --dynamic_weighting_of_learning_p=1 \
--track --wandb_project_name="$WANDB_PROJECT_NAME" --easy=1 --use_monochrome=0 \
--total_timesteps=9000000 --env_id="procgen:procgen-starpilot-v0" \
--int_env_id="procgen:procgen-climber-v0" --proc_sequential
