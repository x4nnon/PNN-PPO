...
for x in "${X_VALUES[@]}"; do
    ...
    --reward_limit=7.5 --env_id="procgen-starpilot" --int_env_id="climber"
    ...
    --reward_limit=15 --all_optimizers --total_timesteps=9000000 --env_id="procgen-starpilot" --int_env_id="climber"
