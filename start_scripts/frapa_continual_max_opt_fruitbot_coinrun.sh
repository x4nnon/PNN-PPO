...
WANDB_PROJECT_NAME="fruitbot_coinrun_frapa_continued_learning_experiment2"
...
for x in "${X_VALUES[@]}"; do
    ...
    --reward_limit=7.5 --all_optimizers --total_timesteps=9000000 --env_id="procgen:procgen-fruitbot-v0" \
